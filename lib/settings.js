...
exports.wallet = {
  ...
  "host": "localhost",
  // port: The port # that the wallet is configured to listen for RPC requests on (default: 51573 for Uzlo wallet)
  "port": 51573,
  // username: The wallet RPC username
  "username": "uzlocoinrpc",
...
exports.shared_pages = {
  ...
  //        Valid options: Cerulean, Cosmo, Cyborg, Darkly, Uzlo, Flatly, Journal, Litera, Lumen, Lux, Materia, Minty, Pulse, Sandstone, Simplex, Sketchy, Slate, Solar, Spacelab, Superhero, United, Yeti
...
exports.markets_page = {
  ...
  "exchanges": {
    ...
    //        NOTE: yobit does not display a 24-hour chart due to yobit's lack of OHLCV api data
    "yobit": {
